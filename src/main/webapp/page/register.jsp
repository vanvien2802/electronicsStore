            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col order-2 order-xs-2 order-lg-12 mt-10 mb-10">
                    ...
                    <div class="header-account-links">
                        <a href="register.jsp"><i class="icofont icofont-user-alt-7"></i> <span>my account</span></a>
                        <a href="login.jsp"><i class="icofont icofont-login d-none"></i> <span>Login</span></a>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-12 d-flex">
                <div class="ee-register">
                    ...
                    <!-- Change Form -->
                    <form action="../CreateUser" id="Changeform">
                        <div class="row">
                        
							<div class="col-12 mb-30"><input name="name" type="text" placeholder="Your name here"></div>
							<div class="col-12 mb-30"><input name="userName" type="text" placeholder="Your userName here" ></div>
                            <div class="col-12 mb-30"><input name="email" type="email" placeholder="Your email here"></div>
                            <div class="col-12 mb-30"><input name="phoneNumber" type="phoneNumber" placeholder="Your phone number here"></div>
                            <div class="col-12 mb-30"><input name="address" type="address" placeholder="Your address here"></div>
                            ...
                            <div class="col-12 mb-30"><input  name="password" type="password" placeholder="Enter passward"></div>
