...
">
            ...
            <div class="col-md-6 col-12 d-flex">
                <div class="ee-register">
                    <h1>Add Producttion</h1>
                    <!-- Change Form -->
                    <form action="../createProduct" id="createProduct" enctype="multipart/form-data" method="post">
                        <div class="row">
                        
							<div class="col-12 mb-30"><input name="namePro" type="text" placeholder="Name Product"></div>
							<div class="col-12 mb-30"><input name="descrip" type="text" placeholder="Description" ></div>
                            <div class="col-12 mb-30">
                            <select form="createProduct" name="type" id="type" class="col-12 mb-30" style ="height:50px; border-radius: 50px; padding: 10px 30px;">
                            		<option value="phone">Phone</option>
									<option value="laptop">Laptop</option>
									<option value="camera">Camera</option>
							</select>
							</div>
                            <div class="col-12 mb-30"><input name="price" type="text" placeholder="Price"></div>
                            <div class="col-12 mb-30"><input name="idUser" value="<%=u.getIdUser() %>" type="text" placeholder="idUser" readonly="readonly"></div>
                        
                            <div class="col-12 mb-30"><input placeholder="storage" type="text" name="storage"></div>
                    ...
                    <div class="account-image-upload">
                        ...
                        <label class="account-image-label" for="account-image-upload">Choose image Product</label>
                    </div>
                    </br></br>
                    
                </div>
                            
                            <div class="col-12"><input type="submit"  value="Add Product"></div>
