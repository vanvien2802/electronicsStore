                ...
                <div class="col order-2 order-xs-2 order-lg-12 mt-10 mb-10">
                    ...
                    <div class="header-account-links">
                        	...
                        	<%
                        		...
                        		products pro = (products)request.getSession().getAttribute("product");
                        ...
                        <a href="login.jsp"><i class="icofont icofont-login"></i><span>Logout</span></a>
            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col order-2 order-lg-12 order-xl-12">
                    ...
                    <div class="header-shop-links">
                        ...
                        <!-- Cart -->
                        <a href="cart.jsp" class="header-cart"><i class="ti-shopping-cart"></i> <span class="number">3</span></a>
    ...
    <div class="page-banner-wrap row row-0 d-flex align-items-center ">
        ...
        <div class="col-lg-4 col-12 order-lg-2 d-flex align-items-center justify-content-center">
            <div class="page-banner">
                <h1>Add Producttion</h1>
                <p>similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita</p>
                <div class="breadcrumb">
                    <ul>
                        <li><a href="#">HOME</a></li>
                        <li><a href="#">Add Production</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
">
            ...
            <div class="col-md-6 col-12 d-flex">
                <div class="ee-register">
                    <h1>Add Producttion</h1>
                    <!-- Change Form -->
                    <form action="../UpdateInfPro"  id="UpdatePro" enctype="multipart/form-data" method="post">
                        <div class="row">
                        
							<div class="col-12 mb-30"><input name="namePro" type="text" placeholder="Name Product" value="<%=pro.getNameProduct() %>"></div>
							<div class="col-12 mb-30"><input name="descrip" type="text" placeholder="Description" value="<%=pro.getTitle() %>"></div>
                            <div class="col-12 mb-30">
                            
                            <select form="UpdatePro" name="type" id="type" class="col-12 mb-30" style ="height:50px; border-radius: 50px; padding: 10px 30px;">
                            		<%
                            			if(pro.getType().equals("phone")){
                            		%>
									<option value="phone" selected>Phone</option>
									<option value="laptop">Laptop</option>
									<option value="camera">Camera</option>
                            		<%
                            			}else if(pro.getType().equals("laptop")){
                            		%>
                            ...
                            <div class="col-12 mb-30"><input name="price" type="text" placeholder="Price" value="<%=pro.getPrice() %>"></div>
                            <div class="col-12 mb-30"><input name="idProduct" value="<%=pro.getIdProduct() %>" type="text" placeholder="IdProduct" readonly="readonly" ></div>
                            <div class="col-12 mb-30"><input name="idUser" value="<%=u.getIdUser() %>" type="text" placeholder="IdProduct" readonly="readonly" ></div>
                        
                            <div class="col-12 mb-30"><input placeholder="storage" type="text" name="storage" value="<%=pro.getStorage() %>"></div>
                    ...
                    %>
                    	<img src="data:image/gif;base64,<%= imgDataBase64 %>" alt="Product Image">
                        <input type="file" name="chooseFile" id="account-image-upload">
                        <label class="account-image-label" for="account-image-upload">Change image Product</label>
                    </div>
                    </br></br>
...
<div class="brands-section section mb-90">
    <div class="container">
        <div class="row">
            ...
            <!-- Brand Slider Start -->
            <div class="brand-slider col" style="
    display: flex;
">
