            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col order-2 order-xs-2 order-lg-12 mt-10 mb-10">
                    ...
                    <div class="header-account-links">
                        ...
                        <a href="myProducts.jsp"><i class="icofont icofont-social-shopify"></i> <span>Myshop</span></a>
            ...
            <div class="page-banner">
                ...
                <div class="breadcrumb">
                    <ul>
                        ...
                        <li><a href="inforAccount.jsp">Your Information</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-12 d-flex">
                <div class="ee-register">
                    ...
                    <!-- Change Form -->
                    <form action="../ChangeInforUser" id="Changeform">
                        <div class="row">
                        
							<div class="col-12 mb-30"><input name="idUser" type="text" placeholder="Your name here" style="background:#ccc" value = <%=u.getIdUser()%> readonly></div>
							<div class="col-12 mb-30"><input name="name" type="text" placeholder="Your name here" value = <%=u.getName()%>></div>
							<div class="col-12 mb-30"><input name="userName" type="text" placeholder="Your userName here" value = <%=u.getUserName()%>></div>
                            <div class="col-12 mb-30"><input name="email" type="email" placeholder="Your email here" value = <%=u.getEmail()%>></div>
                            <div class="col-12 mb-30"><input name="phoneNumber" type="phoneNumber" placeholder="Your phone number here" value = <%=u.getPhoneNumber()%>></div>
                            <div class="col-12 mb-30"><input name="address" type="address" placeholder="Your address here" value = <%=u.getAddress()%>></div>
                            <div class="col-12 mb-30">
                            	<select form="Changeform" name="gender" id="gender" class="col-12 mb-30" style ="height:50px; border-radius: 50px; padding: 10px 30px;">
                            ...
                            <div class="col-12 mb-30"><input  name="password" type="password" placeholder="Enter passward" value = <%=u.getPassword()%>></div>
                            <div class="col-12 mb-30"><input name="rePassword" type="password" placeholder="Conform password"></div>
