            ...
            <div class="col-md-6 col-12 d-flex">
                <div class="ee-login">
                    ...
                    <form action="../CheckLoginServlet" method="post">
                        <div class="row">
                            <div class="col-12 mb-30"><input type="text" placeholder="Your username" name="userName"></div>
                            ...
                            <div class="col-12"><input type="submit" name="submit" value="LOGIN"></div>
                        </div>
                    </form>
                    <h4>Don’t have account? please click <a href="register.jsp">Register</a></h4>
